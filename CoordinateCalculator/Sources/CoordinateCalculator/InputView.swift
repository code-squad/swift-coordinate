...
struct InputView {
    ...
    static func readInput(coordsWithBracelet: String)->MyPoint{
    ...
    static func isUnderAxisLimit(_ point: MyPoint)->Bool{
        var isUnder: Bool = false
        // ANSICode.axis.AxisLimit 을 넘지 않으면 true 반환. 넘으면 false 반환.
        return isUnder
    }
}
